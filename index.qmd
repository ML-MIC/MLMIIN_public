...
+ Today we start the discussion of baseline models (4.3). The Arima session 4.4 has aldo been uploaded, albeit in a provisional version, since we will be updating it in the next sessions.
...
+ [4_3_Baseline_Arima](./pages/sessions/4_3_Baseline/4_3_Baseline.html)
