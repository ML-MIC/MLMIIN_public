...
<!-- ![](fig/QR.png){height=300px} ![ ](fig/orchid.png){height=275px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/surniaUlula.png){height=300px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/leopard.JPG){height=300px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/OrquideaMuñeca.png){height=300px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/pigargo.jpeg){height=250px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/LagopodoCanada.jpg){height=150px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/CercetaCarretona.JPG){height=300px} -->
<!-- ![](fig/QR.png){height=300px} ![ ](fig/weaver.JPG){height=300px} -->
![](fig/QR.png){height=300px} ![ ](fig/Puffin.JPG){height=300px}
...
+ Solving the 2025 Final Exam.

## 2026-04-21 Session

+ Final Unsupervised Learning session. 

## 2026-04-15 Session

+ Unsupervised Learning session: hierarchical clustering. 

## 2026-04-14 Session

+ First Unsupervised Learning session: PCA and first cluster ideas.

## 2026-04-08 Session

+ Added a link to last year's sessions code.

## 2026-04-07 Session

+ Session 4.5 on SARIMAX (SARIMA  with exogenous variables) and Machine Learning models has been pushed to the repository. 

## 2026-03-25 Session

+ The Arima session 4.4 has been updateD to a (more) complete version.
...
+ The files for the midterm are expected to ba available by doing a regular git pull for the course repository. But in case of need they can be obteined as a password protected zip file at [this link](./midterm26.zip). The password will be provided at the beginning of the midterm session. Uncompress this file inside the repository folder `MLMIIN`, and you will find a folder called `midterm26` with all the files you need to work on the midterm. Delete the `midterm26.zip` file after uncompressing, to avoid conflicts afterwards.

## 2026-02-25 Session (3h)

+ <div style="color:red;font-weight:bold">Midterm date:</div> 2026-03-26, 15:00-17:00. Location: room 201.
...
+ [*Hyperparameter Tuning with Python* by Louis Owen](https://www.packtpub.com/en-es/product/hyperparameter-tuning-with-python-9781803241944?srsltid=AfmBOop-6dH9yOSasLP6Ure3zHPgHK_f0Q1EGNXQ6Cx6HHbXml-UukQQ)
...
+ [3_4_NeuralNetworks](./pages/sessions/3_4_Intro_to_NN/3_4_Intro_to_NN.html)

## Forecasting Sessions

+ [4_1_Introduction_to_Forecasting](./pages/sessions/4_1_Introduction_to_Forecasting/4_1_Introduction_to_Forecasting_local.html)
+ [4_2_Stationarity](./pages/sessions/4_2_Stationarity/4_2_Stationarity_local.html)
+ [4_3_Baseline](./pages/sessions/4_3_Baseline/4_3_Baseline.html)
+ [4_4_Arima](./pages/sessions/4_4_Arima/4_4_Arima.html)
+ [4_5_Forecasting_Exogenous_Prophet](./pages/sessions/4_5_SARIMAX_AutoARIMA_ML_Models/4_5_SARIMAX_AutoARIMA_ML_Models.html)

## Unsupervised Learning Sessions

+ [5_1_PCA](./pages/sessions/5_1_Unsupervised_PCA/5_1_PCA_local.html)
+ [5_2_Clustering](./pages/sessions/5_2_Clustering/5_2_Clustering_local.html)
+ [5_3_Density_Estimation](./pages/sessions/5_3_Density_Estimation/5_3_Density_Estimation.html)


## [Link to 2025 Sessions](https://fsansegundo.github.io/MLMIC25_public/)
